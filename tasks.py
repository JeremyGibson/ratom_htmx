...
def staging(c):
    ...
    c.config.namespace = "ratom_htmx-staging"


@invoke.task
def production(c):
    c.config.env = "production"
    c.config.namespace = "ratom_htmx-production"
...
ns.configure(
    {
        "app": "ratom_htmx_app",
        "aws": {"region": "<<FILL_IN>>", "profile_name": "ratom_htmx"},
        "cluster": "ratom_htmx-stack-cluster",
        "container_name": "app",
