...
from ratom_htmx.settings.base import *  # noqa: F403
...
EMAIL_SUBJECT_PREFIX = "[ratom_htmx %s] " % ENVIRONMENT.title()
...
### ADMINS and MANAGERS
ADMINS = (("ratom-htmx Dev Team", "ratom_htmx-team@caktusgroup.com"),)
