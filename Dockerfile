...
COPY --from=static_files /code/ratom_htmx/static /code/ratom_htmx/static
...
ENV DJANGO_SETTINGS_MODULE=ratom_htmx.settings.deploy
...
ENV UWSGI_WSGI_FILE=ratom_htmx/wsgi.py
